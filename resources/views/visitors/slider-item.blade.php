<div class="ls-slide"
    ...
    <div class="slider-content ls-l" style="top:60%; left:30%;"
        ...
        {{--TODO: setup anchor--}}
        <a class="btn" href="#">{{ ucfirst(strtolower($blog->tag)) }}</a>
        <h3 class="title" style="max-width: 550px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap"><b>{{ $blog->title }}</b></h3>
